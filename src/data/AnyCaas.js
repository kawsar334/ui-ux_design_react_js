export const items = [
    { title: 'Easy Card Issuance & Management', description: 'Issue and manage all types of payment cards, including debit, credit, prepaid, and virtual cards via a unified platform. Easily configure card rules, limits, and policies per your business needs.', img: "https://cdn.sanity.io/images/6jywt20u/production/0d7e6faf925dd55d78fe41a3b748cf18cc25af19-50x50.svg?w=50&auto=format" },
    { title: 'Flexible API Integration', description: 'Our robust APIs ensure seamless integration with your existing infrastructure, enabling real-time data exchange and cross-platform compatibility.', img: 'https://cdn.sanity.io/images/6jywt20u/production/87af08293976a2895fb63d4dcc17a493703b4637-50x50.svg?w=50&auto=format' },
    { title: 'Customisable Card Design', description: 'Leverage our platform to create unique card designs that reflect your brand identity.', img: "https://cdn.sanity.io/images/6jywt20u/production/869185bc816f374d0062fec4147694ee2b7a79e9-50x50.svg?w=50&auto=format" },
...
export const items2 = [
    ...
    { title: 'Scalability', description: 'AnyTech’s scalable architecture is built to support a export constantly growing customer base and an evolving portfolio of products and services.', img: "https://cdn.sanity.io/images/6jywt20u/production/09def8db67d41777c5b9c853c0c8e2eecf70d390-50x50.svg?w=50&auto=format" },
...
export const images = {
    ...
    miniImagefive: 'https://cdn.sanity.io/images/6jywt20u/production/5289408485b30d4f4d649b5205079ed0ce26d879-160x175.svg?w=320&auto=format',
    imageFoure: "https://cdn.sanity.io/images/6jywt20u/production/ed8251e42d17f9739645130f8714616ad807ba13-375x455.png?w=375&auto=format"
}
export const title = "Anycaas"
export const desc1 = "The future of card services"
export const desc2 = "Our Cards-as-a-Service (CaaS) solution empowers financial institutions to issue, manage and process payment cards seamlessly and securely.";
export const desc3 = "Cut down on the complexities and costs of traditional card issuance and processing systems by leveraging our robust platform that streamlines card management."
export const desc4 = "Champion the future of card services with AnyCaaS. Revolutionise your card programmes, deliver superior customer experiences, and drive growth."
...
export const designTitle = "Solutions"
export const desgnDesc = "Designed for your needs";

export const data = {
    title: "Robust card issuance and management",
    desc: "Reimagine financial services with AnyTech’s open platform, distributed banking solution that powers transformation",
    img: "https://cdn.sanity.io/images/6jywt20u/production/a0d52dbf3dc616daa67af788c08edd1305f7dfe9-235x43.svg?w=235&auto=format"
}