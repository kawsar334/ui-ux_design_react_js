...
const Execution = ({ title, desc1, desc2, desc3, desc4, images}) => {
  ...
  return (
      <div className='w-[90%]  mx-auto flex justify-between items-center gap-3 flex-col md:flex-row shape1 '>
          ...
          <div className="left  p-5  w-full md:w-[50%]">
              ...
              {desc4 && <p className='text-[14px]'>{desc4}</p>}
          </div>
          ...
          <div className="right relative    w-full md:w-[43%] ">
            ...
            <Svg/>
              ...
              {images?.imageOne && <img src={images?.imageOne} alt="" className='  object-cover w-[120px] h-[120px]  absolute  z-10 top-[100px] md:top-[190px] left-[-20px] ' />}
