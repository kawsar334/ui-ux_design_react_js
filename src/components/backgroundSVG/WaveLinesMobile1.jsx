...
const WaveLinesMobile1 = () => {
  return (
      <div className=''><svg width="390" height="641" viewBox="0 0 390 641" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g style={{ mixBlendMode: "multiply" }}>
              <path d="M361 -192.212V-388L-272 245H-76.2114L361 -192.212Z" fill="url(#paint0_linear_17_106)" />
          </g>
          ...
          <g filter="url(#filter1_f_17_106)">
              <path d="M658 -95.3209V-211L284 163H399.679L658 -95.3209Z" fill="url(#paint4_linear_17_106)" />
          </g>
          <defs>
              ...
              <linearGradient id="paint2_linear_17_106" x1="-149.029" y1="340.992" x2="95.7598" y2="85.952" gradientUnits="userSpaceOnUse">
...
export default WaveLinesMobile1