...
const Design = ({ title, desc, items }) => {
  ...
  return (
    <div className='w-[90%] md:w-[80%] mx-auto my-10 '>
      <div className='w-full mx-auto text-center' data-aos="zoom-in">
        ...
        <div className='flex justify-center items-center gap-5  my-10'>
            {items.map(item => (
              <div data-aos="zoom-in" key={item.id} className='flex flex-col gap-10 shadow  md:gap-10 w-full md:w-[50%] hover:border transition-all duration-700 cursor-pointer p-7 rounded'>
