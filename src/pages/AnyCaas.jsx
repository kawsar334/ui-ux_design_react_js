...
const AnyCaas = () => {
    ...
    const title = "Anycaas"
    const desc1 = "The future of card services"
    const desc2 = "Our Cards-as-a-Service (CaaS) solution empowers financial institutions to issue, manage and process payment cards seamlessly and securely.";
    const desc3 = "Cut down on the complexities and costs of traditional card issuance and processing systems by leveraging our robust platform that streamlines card management."
      const   desc4 ="Champion the future of card services with AnyCaaS. Revolutionise your card programmes, deliver superior customer experiences, and drive growth."
    ...
    return (
        <div>
            ...
            <AnyComponent title="Key Features" subtitle="Superior customer experiences" items={items} />
            <AnyComponent title="Benefits" subtitle="Revolutionise your card programmes" items={items2} />
            <Marquee/>
            title, desc, items
