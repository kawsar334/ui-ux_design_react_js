...
const AnyPaas = () => {
    ...
    const desc3 = "Designed by our expert team, AnyPaas provides powerful infrastructure that allows banks to innovate, scale, and adapt in today's fast-paced digital environment."
    const desc4 = "AnyPaas is more than just a platform—it's a strategic partner in your digital transformation journey. Embrace the future of banking with AnyTech and redefine what your institution can achieve in the digital age."
    ...
    return (
        <div>
            ...
            <AnyComponent title="Key Features" subtitle="Seamless and 
secure experiences" items={items} />
            <AnyComponent title="Benefits" subtitle="Fast and efficient 
payments" items={items2} />
            <Marquee />
            title, desc, items
